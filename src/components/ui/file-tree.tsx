...
const Tree = forwardRef<HTMLDivElement, TreeViewProps>(
  (
    ...
    const selectedIdProp = controlledSelectedId ?? initialSelectedId
    ...
    useEffect(() => {
      if (selectedIdProp) {
        expandSpecificTargetedElements(elements, selectedIdProp)
      }
    }, [selectedIdProp, elements, expandSpecificTargetedElements])
  ...
  (
    ...
    return (
      <button
        ...
        disabled={!isSelectable}
        className={cn(
          "flex w-full items-center gap-1 rounded-md text-sm duration-200 ease-in-out",
          {
